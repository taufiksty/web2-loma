...
<div class="flex flex-col w-full lg:flex-row my-24">
  <div class="sticky top-20 px-14 h-full card rounded-box place-items-center">
    ...
    <a href="<?= base_url(); ?>/Rekruter/lihatLamaranMasuk/Volunteer/<?= $detail_volunteer[0]['id']; ?>/<?= $detail_volunteer[0]['id_rekruter']; ?>" class="btn btn-accent mt-9">Lihat Lamaran Masuk</a>
  </div>
  ...
  <div class="grid flex-grow h-full card rounded-box place-items-center px-14 pt-5">
    ...
    <div class="flex justify-end w-full mt-24">
      <a href="<?= base_url(); ?>/Volunteer/hapusLowongan/<?= $detail_volunteer[0]['id']; ?>/<?= $detail_volunteer[0]['id_rekruter']; ?>" class="btn btn-error px-5 mr-5 font-medium text-base" onclick="confirm('Apakah anda yakin ingin menghapus lowongan? Pelamar yang telah melamar akan diberitahu secara otomatis.');">Hapus Lowongan</a>
      <a href="<?= base_url(); ?>/Rekruter/editLowongan/<?= $detail_volunteer[0]['id_rekruter']; ?>/<?= $detail_volunteer[0]['id']; ?>" class="btn btn-warning px-16 font-medium text-base">Edit Lowongan</a>
    </div>
  </div>
</div>
