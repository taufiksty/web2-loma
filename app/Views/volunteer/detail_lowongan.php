...
<div class="flex flex-col w-full lg:flex-row my-24">
  <div class="sticky top-20 px-14 h-full card rounded-box place-items-center">
    ...
    <p class="mt-4 font-bold text-xl"><?= $detail_volunteer[0]['posisi']; ?></p>
    <p class="mt-4 font-semibold text-lg"><?= $detail_volunteer[0]['nama_perusahaan']; ?></p>
    <p class="mt-4 text-lg"><?= $detail_volunteer[0]['wilayah_penempatan']; ?></p>
  ...
  <div class="grid flex-grow h-full card rounded-box place-items-center px-14 pt-5">
    ...
    <div class="flex justify-end w-full mt-24">
      ...
      <a href="<?= base_url(); ?>/lamar/<?= $detail_volunteer[0]['tipe'] ?>/<?= $detail_volunteer[0]['id']; ?>/<?= $pelamar['id']; ?>" class="btn btn-primary px-20 font-bold text-lg">Lamar</a>
    </div>
  </div>
</div>
